...
const dirWithIcons = 'src/assets/svg/icons'
...
// for running svgr (to transform svg to components): pnpx @svgr/cli --out-dir src/components/ui/icons --jsx-runtime automatic --typescript --ref --no-dimensions -- src/assets/svg/icons